...
ietsi_hex <- hexSticker::sticker(
    ...
    # 
    # # Save file
    filename             = "../images/ietsi-redcap.png"
...
```{r}
save_sticker("../images/ietsi-redcap-hex.png",
             ietsi_hex,
             dpi         = 600)
```
...
```{r}
# Extrayendo fondo
logo <- image_read("../images/ietsi-redcap-hex.png")

logo %>% 
  image_transparent('white') %>% 
  image_write("../images/ietsi-redcap-hexsticker-transparent.png", "png")
```
